...
lines(sp$freq,ARMAspec(model = list(ar = phi),freq = sp$freq,plot = FALSE)$spec,
lty = "dotted")
...
ylab = "Log(Smoothed Sample Spectrum)",ci.plot = TRUE,ci.col = NULL)
lines(sp$freq,ARMAspec(model = list(ar = phi),sp$freq,plot = FALSE)$spec,lty = "dashed")
abline(h = 0)
...
sp = spec(star,sub = "",main = "",taper = taper,plot = FALSE)
temp = c(temp,sp$spec)
}
for (taper in c(0,0.1,0.2,0.5) ) {
...
sp2 = spec(y,,spans = 9,plot = FALSE)
sp3 = spec(y,,spans = 15,plot = FALSE)
...
lines(f,ARMAspec(model = list(ar = c(phi1,phi2)),freq = f,plot = FALSE)$spec,
lty = "solid")
...
f = seq(0.001,.5,by = .001)
lines(f,ARMAspec(model = list(ar = c(phi1,phi2)),freq = f,plot = FALSE)$spec,lty = "solid")
...
sp1 = spec(y,spans = 11,main = "",sub = "",lty = "dotted", xlab = "Frequency",
 ylab = "Log(Estimated Spectral Density)")
sp2 = spec(y,spans = 22,plot = FALSE)
sp3 = spec(y,spans = 44,plot = FALSE)
lines(sp2$freq,sp2$spec,lty = "dashed")
lines(sp3$freq,sp3$spec,lty = "dotdash")
f = seq(0.001,.5,by = .001)
lines(f,ARMAspec(model = list(ar = phi,ma = -theta),f,plot = FALSE)$spec,lty = "solid")
...
sp2 = spec(y,,spans = 12,plot = FALSE)
sp3 = spec(y,,spans = 24,plot = FALSE)
lines(sp2$freq,sp2$spec,lty = "dashed")
lines(sp3$freq,sp3$spec,lty = "dotdash")
f = seq(0.001,.5,by = .001)
lines(f,ARMAspec(model = list(ma = -theta,seasonal = list(sma = -THETA,period = 12)),
freq = f,plot = FALSE)$spec,lty = "solid")
...
# Exhibit 14.19
sp5 = spec(y,spans = c(3,3),main = "",sub = "",lty = "dotted",demean = TRUE,
 xlab = "Frequency",ylab = "Log(Estimated Spectral Density)")
f = seq(0.001,.5,by = .001)
lines(f,ARMAspec(model = list(ma = -theta,seasonal = list(sma = -THETA,period = 12)),
freq = f,plot = FALSE)$spec,lty = "solid")
...
# Exhibit 14.21
spec(robot,spans = c(7,7),taper = .1,demean = TRUE,main = "",sub = "",
 ylab = "Log(Spectrum)", xlab = "Frequency")
s = spec(robot,method = "ar",plot = FALSE)
...
spec(log(flow),spans = c(7,7),main = "",sub = "",ylim = c(.02,13),
 ylab = "Log(Spectrum)",xlab = "Frequency")
s = spec(log(flow),method = "ar",plot = FALSE)
lines(s$freq,s$spec,lty = "dotted")
s$method
...
data(milk)
spec(milk,spans = c(3,3),detrend = TRUE,sub = "",main = "",
...
xlab = "Frequency",sub = "")
s = spec(trombone,spans = c(11,11),plot = FALSE)
lines(s$freq,s$spec,lty = "dotted")
