...
# Exhibit 15.12
predator.tar.1 <- tar(y = log(predator.eq),p1 = 4,p2 = 4,d = 3,a = .1,b = .9,print = TRUE)

#Repeat the model fit but using the CLS method of estimation, with p1 = 1 and p2 = 4
tar(y = log(predator.eq),p1 = 1,p2 = 4,d = 3,a = .1,b = .9,print = TRUE,method = "CLS")
...
tar(y = log(predator.eq),p1 = 4,p2 = 4,d = 3,a = .1,b = .9,print = TRUE,method = "CLS")


# Discussions below Exhibit 15.12
predator.tar.2 <- tar(log(predator.eq),p1 = 1,p2 = 1,d = 3,a = .1,b = .9,print = TRUE)
...
spec.1.4 <- spec(yy.1.4,taper = .1, span = c(200,200),plot = FALSE)
spec.1 <- spec(yy.1,taper = .1, span = c(200,200),plot = FALSE)
spec.predator <- spec(log(predator.eq),taper = .1, span = c(3,3),plot = FALSE)
